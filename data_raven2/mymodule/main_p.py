...
class MyApp(QDialog):
    ...
    def initUI(self):
        ...
        # 풀버젼
        # pyinstaller --hidden-import PyQt5 --hidden-import pyserial --hidden-import requests --hidden-import chardet --add-data="C:\\my_games\\raven2\\data_raven2;./data_raven2" --add-data="C:\\my_games\\raven2\\mysettings;./mysettings" --name raven2 -i="raven2.ico" --add-data="raven2.ico;./" --icon="raven2.ico" --paths "C:\Users\1_S_3\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2" main.py
        # 업데이트버젼
        # pyinstaller --hidden-import PyQt5 --hidden-import pyserial --hidden-import requests --hidden-import chardet --add-data="C:\\my_games\\game_folder\\data_game;./data_game" --name game_folder -i="game_folder_macro.ico" --add-data="game_folder_macro.ico;./" --icon="game_folder_macro.ico" --paths "C:\Users\1_S_3\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2" main.py
...
class FirstTab(QWidget):
    ...
    def initUI(self):
        ...
        cb6 = QComboBox()
        list6 = ['스케쥴 선택', '각종템받기', '버프와물약사기', '거래소등록', '튜토육성', '특무대_엘베름', '특무대_하코트', '특무대_마두마리스', '자동사냥']
        cb6.addItems(list6)
        vbox6 = QHBoxLayout()
        vbox6.addWidget(cb6)
        ...
        dun_g3_list = ['서브퀘스트 선택', '서브퀘스트_벨루시아', '서브퀘스트_데론', '서브퀘스트_로메른', '서브퀘스트_시너림']
    ...
    def onActivated_dunjeon_1_add(self):
        ...
        elif onDunjeon_1 == '던전선택' or onDunjeon_1 == 'none' or onDunjeon_1_level == 0 or onDunjeon_1_level == "단계":
            pyautogui.alert(button='넵', text='던전 및 층수를 선택해 주시지예', title='아 진짜 뭐합니꺼')
        elif onCharacter != 0 and (onDunjeon_1 != '던전선택' or onDunjeon_1 != 'none'):
            print('char_', char_)
            print('dun_', dun_)
    ...
    def onActivated_dunjeon_2_add(self):
        char_ = onCharacter
        dun_ = "일반_" + str(onDunjeon_2) + "_" + str(onDunjeon_2_level)
        if onCharacter == 0:
            pyautogui.alert(button='넵', text='캐릭터를 선택해 주시지예', title='뭐합니꺼')
        elif onCla == 'none':
            pyautogui.alert(button='넵', text='몇 클라인지 선택해 주시지예', title='뭐합니꺼')
        elif onDunjeon_2 == '던전선택' or onDunjeon_2 == 'none' or onDunjeon_2_level == 0 or onDunjeon_2_level == "단계":
            pyautogui.alert(button='넵', text='던전 및 층수를 선택해 주시지예', title='아 진짜 뭐합니꺼')
        elif onCharacter != 0 and (onDunjeon_2 != '던전선택' or onDunjeon_2 != 'none'):
            print('char_', char_)
            print('dun_', dun_)
            ...
            if thisRow < len(modi_ready_):
                ...
                with open(file_path3, "r", encoding='utf-8-sig') as file:
                    ...
                    if thisCol < 5:
                        ...
                        last_1 = str(modi_spl_3[0]) + ":" + str(modi_spl_3[1]) + ":" + str(
                            modi_spl_3[2]) + ":" + str(
                            modi_spl_3[3]) + ":" + str(modi_spl_1[4]) + ":" + str(modi_spl_1[5]) + ":" + str(
                            modi_spl_1[6]) + ":" + str(modi_spl_1[7])
                        last_2 = str(modi_spl_4[0]) + ":" + str(modi_spl_4[1]) + ":" + str(
                            modi_spl_4[2]) + ":" + str(
                            modi_spl_4[3]) + ":" + str(modi_spl_2[4]) + ":" + str(modi_spl_2[5]) + ":" + str(
                            modi_spl_2[6]) + ":" + str(modi_spl_2[7])
                    else:

                        last_1 = str(modi_spl_1[0]) + ":" + str(modi_spl_1[1]) + ":" + str(
                            modi_spl_1[2]) + ":" + str(
                            modi_spl_1[3]) + ":" + str(modi_spl_3[4]) + ":" + str(modi_spl_3[5]) + ":" + str(
                            modi_spl_3[6]) + ":" + str(modi_spl_3[7])
                        last_2 = str(modi_spl_2[0]) + ":" + str(modi_spl_2[1]) + ":" + str(
                            modi_spl_2[2]) + ":" + str(
                            modi_spl_2[3]) + ":" + str(modi_spl_4[4]) + ":" + str(modi_spl_4[5]) + ":" + str(
                            modi_spl_4[6]) + ":" + str(modi_spl_4[7])
