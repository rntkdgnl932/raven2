    ...
    try:
        ...
        while col_ is False:
            ...
            if imgs_ is not None and imgs_ != False:
                ...
                print("스페샬")
                for i in range(10):
                    full_path = "c:\\my_games\\raven2\\data_raven2\\imgs\\collection\\col_event_1.PNG"
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set_(20, 80, 200, 600, cla, img, 0.8)
                    if imgs_ is not None and imgs_ != False:
                        print("col_event_1", imgs_)
                        click_pos_reg(imgs_.x, imgs_.y, cla)
                        break
                    else:
                        full_path = "c:\\my_games\\raven2\\data_raven2\\imgs\\collection\\col_special_1.PNG"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                        imgs_ = imgs_set_(20, 80, 200, 600, cla, img, 0.8)
                        if imgs_ is not None and imgs_ != False:
                            print("col_special_1", imgs_)
                            click_pos_reg(imgs_.x, imgs_.y, cla)
                            time.sleep(0.5)
                        else:
                            full_path = "c:\\my_games\\raven2\\data_raven2\\imgs\\collection\\col_special_2.PNG"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set_(20, 80, 200, 600, cla, img, 0.8)
                            if imgs_ is not None and imgs_ != False:
                                print("col_special_2", imgs_)
                                click_pos_reg(imgs_.x, imgs_.y, cla)
                                time.sleep(0.5)
                    time.sleep(0.5)
                ...
                for i in range(10):
                    ...
                    if imgs_ is not None and imgs_ != False:
                        ...
                        if imgs_ is not None and imgs_ != False:
                            ...
                            full_path = "c:\\my_games\\raven2\\data_raven2\\imgs\\collection\\col_point_event.PNG"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set_(450, 140, 670, 1020, cla, img, 0.8)
                            if imgs_ is not None and imgs_ != False:
                ...
                for i in range(10):
                    ...
                    if imgs_ is not None and imgs_ != False:
                        ...
                        full_path = "c:\\my_games\\raven2\\data_raven2\\imgs\\menu\\menu_collection.PNG"
                        img_array = np.fromfile(full_path, np.uint8)
                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                for i in range(15):
                    ...
                    if imgs_ is not None and imgs_ != False:
                        ...
                        if imgs_ is not None and imgs_ != False:
                            ...
                            click_pos_2(400, 950, cla)

                    else:
                        click_pos_2(370, 865, cla)
